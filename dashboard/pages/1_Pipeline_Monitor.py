        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                if history:
                    ...
                    st.info("No data quality metrics yet. Run the pipeline to populate this view.")
        except Exception:
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                if anomalies:
                    ...
                    st.info("No anomalies recorded yet. Run the pipeline to populate this view.")
        except Exception:
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                if history:
                    ...
                    st.info("No schema drift history recorded yet. Run the pipeline to populate this view.")
        except Exception:
