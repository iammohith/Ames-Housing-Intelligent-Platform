...
QueryIntent = Literal[
    "neighborhood", "model_performance", "data_quality",
    "anomaly", "feature", "temporal", "general"
]

INTENT_KEYWORDS = {
    "neighborhood": ["neighborhood", "area", "location", "where", "region", "nridg", "names", "meadow"],
    "model_performance": ["r2", "r²", "rmse", "mae", "model", "accuracy", "score", "predict", "xgboost", "ridge"],
    ...
    "temporal": ["year", "month", "time", "trend", "season", "2006", "2007", "2008", "2009", "2010"],
}
